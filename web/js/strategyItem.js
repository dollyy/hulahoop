...
/*        type:"post",
        ...
        success:function(data){
            var data={"province":"澳门","duration":"5天","catalog":["1","2","3","4","5","评论"],"content":[[1],[2],[3],[4],[5]],"comments":[["1","1","user1","2018-01-23 19:03:25","位置位置位置位置","2","3","5"],["3","2","user2","2018-01-24 10:33:25","位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置","6","5","4"],["4","3","user3","2018-01-25 18:33:55","位置位置位置位置位置位置位置位置位置位置位置位置位置位置","7","4","7"],["5","4","user4","2018-01-25 09:34:34","位置位置位置位置位置","9","2","6"],["1","1","user1","2018-01-23 19:03:25","位置位置位置位置","2","3","5"],["3","2","user2","2018-01-24 10:33:25","位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置","6","5","4"],["4","3","user3","2018-01-25 18:33:55","位置位置位置位置位置位置位置位置位置位置位置位置位置位置","7","4","7"],["5","4","user4","2018-01-25 09:34:34","位置位置位置位置位置","9","2","6"],["1","1","user1","2018-01-23 19:03:25","位置位置位置位置","2","3","5"],["3","2","user2","2018-01-24 10:33:25","位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置位置","6","5","4"],["4","3","user3","2018-01-25 18:33:55","位置位置位置位置位置位置位置位置位置位置位置位置位置位置","7","4","7"],["5","4","user4","2018-01-25 09:34:34","位置位置位置位置位置","9","2","6"]]};
