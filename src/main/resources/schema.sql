...
CREATE TABLE `feedback_info` (
  ...
  `parent` varchar(50) NOT NULL COMMENT '这条反馈信息是哪条反馈信息的回复,值为第一条反馈信息的level',
...
VALUES
  ('今天是几号呀', '1', '0', 1, 1, '2017-12-15 11:11:11'),
  ('16号', '2.2', '2', 2, 3, '2017-12-15 11:11:13'),
  ('嘿嘿', '2.1.1', '2.1', 1, 3, '2017-12-15 11:11:13'),
  ('哈哈', '1.1.1', '1.1', 1, 3, '2017-12-15 11:11:13'),
  ('造了', '2.1.2', '2.1', 2, 1, '2017-12-15 11:11:12'),
  ('好嘞', '1.1.2', '1.1', 2, 1, '2017-12-15 11:11:12'),
  ('12.15', '1.2', '1', 2, 3, '2017-12-15 11:11:13'),
  ('明天是几号啊', '2', '0', 2, 1, '2017-12-15 11:11:11'),
  ('12.16', '2.1', '2', 1, 2, '2017-12-15 11:11:12'),
  ('不造啊', '1.3', '1', 3, 4, '2017-12-15 11:11:14'),
  ('15号', '1.1', '1', 1, 2, '2017-12-15 11:11:12'),
  ('emmmm', '2.3', '2', 3, 4, '2017-12-15 11:11:14'),
  ('hhhh不告诉你', '1.4', '1', 4, 5, '2017-12-15 14:50:02');
...
VALUES (2,'你好','你好呀',1,0,1,'2018-02-27 12:23:45'),(2,'登录','首次登录',2,0,1,'2018-02-27 12:23:46'),
...
SELECT * FROM feedback_info WHERE parent=0;
